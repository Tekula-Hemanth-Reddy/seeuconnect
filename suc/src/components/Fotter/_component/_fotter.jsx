        ...
        <Jumbotron className="fotter">
            <div className="row">
                ...
                <div className="col-lg-4 col-md-5 col-sm-6 col-xl-3 contactUs">
                    ...
                    <ul className="listStyles">
                        ...
                        <li className="unOrderListItems fotterDivisionLinks"><FontAwesomeIcon className='ico' icon={faEnvelopeSquare} color="#007bff" size="md" /><a href="mailto:dummy@gmail.com" className="contactDecorations" style={{textDecoration:"none"}}>dummy@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div >
                <ul className="listStyles" style={{paddingLeft: "0px"}}>
                    <li style={{display: "inline", margin: "15px"}}><FontAwesomeIcon className='ico' icon={faFacebook} color="#007bff" size="lg" /></li>
                    <li style={{display: "inline", margin: "15px"}}><FontAwesomeIcon className='ico' icon={faInstagram} color="#007bff" size="lg" /></li>
                    <li style={{display: "inline", margin: "15px"}}><FontAwesomeIcon className='ico' icon={faTwitter } color="#007bff" size="lg" /></li>
